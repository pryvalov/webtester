...
<div style="position: absolute; top: 130px; left: 260px; padding: 3px;" class="quiz">
...
<div style="position: absolute; top: 350px; left: 290px;" class="quiz" id="quiz-question"> 
<c:if test="${question!=null}">
...
# ${answerStatus.index + 1}
   ${answer.answerText}</td>
<td> <input type="checkbox" name="selected" value="${answer.idAnswer}"></td>
  </tr>
...
<td> <input type="checkbox" name="selected" value="-1"></td>
  ...
  <tr><td colspan="2"><input type="submit" class="common-button" value="Next"></td></tr>
</table>
</form>
</c:if>
